...
- **Multi-LLM Support**:
  ...
  - High-complexity queries: Premium LLM
...
- API keys for LLM providers (Groq API)
...
LLM_MODEL_LOW=openai/gpt-oss-20b
LLM_MODEL_MEDIUM=qwen/qwen3.8-27b
LLM_MODEL_HIGH=openai/gpt-oss-120b
```
